...
module.exports = app => {
  ...
  app.delete("/logs", (req, res)=>{
    ...
    if (LOGFILE.delete(name)) {
      ...
      if (logs_idx > -1) LOGS_LIST_CACHE.splice(logs_idx, 1)
    } else {
      res.json({
        rescode: 404,
